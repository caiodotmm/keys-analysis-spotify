...
# Selectbox feature allowing different dataset sizes
st.session_state.dataset_size_option = st.selectbox(
    "Choose a Dataset size you'd like to analyze",
    ("100% (Full Dataset)", "75%", "50%", "25% (Default)"),
    index=3,
)
...
st.session_state.size = st.session_state.dataset_size_option.split("%")
st.session_state.df = load_dataset(f"data/keys_spotify_data-{st.session_state.size[0]}.csv.gz")
